...
Ice.loadSlice("-I ./generated/ --all ./generated/Laser.ice")
...
class Requires:
    def __init__(self, ice_connector:Ice.CommunicatorI, parameters):
        ...
        self.DifferentialRobot = self.create_proxy("DifferentialRobot", RoboCompDifferentialRobot.DifferentialRobotPrx, parameters["Proxies"]["DifferentialRobot"])
        self.Laser = self.create_proxy("Laser", RoboCompLaser.LaserPrx, parameters["Proxies"]["Laser"])
